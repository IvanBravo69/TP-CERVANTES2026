  ...
  return (
    <>
      ...
      >
        ...
        <div className="form-row">
          <div className="form-group"><label className="form-label">DNI *</label><input className={errCls('form-control','dni_cuit')} value={modal.data.dni_cuit||''} onChange={setF('dni_cuit')} placeholder="12345678" /></div>
