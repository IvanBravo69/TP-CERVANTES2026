function pagRange(page, total) {
  ...
  if (page <= 4)  return [1, 2, 3, 4, 5, 'â€¦', total]
  if (page >= total - 3) return [1, 'â€¦', total-4, total-3, total-2, total-1, total]
  return [1, 'â€¦', page-1, page, page+1, 'â€¦', total]
}
    ...
    <div className="pagination-bar">
      ...
      <div className="pagination-controls">
        ...
        {pagRange(page, totalPages).map((p, i) =>
          p === 'â€¦'
            ? <button key={`dots-${i}`} className="pg-btn" disabled>â€¦</button>
